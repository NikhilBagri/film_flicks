        ...
        {searchResults.length > 0 && (
          <ul>
            {searchResults.map((movie) => (
              <li
                className="cursor-pointer text-xs sm:text-lg border-2 py-2 hover:bg-gray-700 flex justify-between items-center"
                key={movie.id}
              >
                ...
                <img
                  ...
                  src={`https://image.tmdb.org/t/p/original/${
                    movie.backdrop_path || "placeholder.jpg" // Use a placeholder image name here
                  }`}
                  width={100}
                  onError={handleImageError} // Added error event handler here
                />
              </li>
            ))}
          </ul>
